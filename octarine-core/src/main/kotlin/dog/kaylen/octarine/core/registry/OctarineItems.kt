...
object OctarineItems : NamespacedRegistry<Item>(OctarineMod.MOD_ID, Registries.ITEM) {
    ...
    val OCTIRON_ORE_BLOCK =
        createBlockItem("octiron_ore", OctarineBlocks.OCTIRON_ORE, ItemGroups.BUILDING_BLOCKS) {}
    val DEEPSLATE_OCTIRON_ORE_BLOCK =
        createBlockItem(
            "deepslate_octiron_ore",
            OctarineBlocks.DEEPSLATE_OCTIRON_ORE,
